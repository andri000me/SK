...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2018 at 09:49 AM
...
CREATE TABLE `tb_sk_syarat` (
  ...
  `sk_file_pendukung` varchar(250) DEFAULT NULL,
  `sk_file_pendukung_2` varchar(500) DEFAULT NULL,
  `sk_file_pendukung_3` varchar(500) DEFAULT NULL,
...
--
ALTER TABLE `tb_briohukum`
  MODIFY `sk_id_biro_hukum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `tb_sk_syarat`
--
ALTER TABLE `tb_sk_syarat`
  MODIFY `sk_id_syarat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
