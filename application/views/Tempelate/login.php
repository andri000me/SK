...
<body class="gray-bg" style="background:; position: center">
    <nav class="navbar navbar-default animated fadeInDown" style="background:#a0ce4e; height: 100px;">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand"><img src="<?php echo base_url()?>assets/img/header.png" style="height: 75px;" class="img-responsive"></a>
                        ...
                        <div class="ibox float-e-margins">
                            <div>
                                <div class="ibox-content no-padding border-left-right">
                                    <img alt="image" class="img-responsive" src="<?php echo base_url()?>assets/img/kantorgubntb.jpg" style="height: 310px; width: 1000px">
                                </div>
                        ...
                        <div class="ibox-content text-center">
                            <div class="tabs-container">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#tab-1"> Login Sistem</a></li>
                                ...
                                <div class="tab-content">
                                    <div id="tab-1" class="tab-pane active">
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url('portalredaktuladmin/proses') ?>">
                            ...
                            <p class="m-t">
                               <small>Biro Hukum Provinsi NTB &copy; 2018</small>
                           </p>
                       </div>
                   </div>
               </div>
   ...
   <script type="text/javascript">
    $(window).load(function(){$("#pesan").fadeOut(8000);})
</script>
</body>
